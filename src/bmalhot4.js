...
const BLOB_IMAGES = ["../images/col1.png", "../images/col2.png", "../images/col3.png", "../images/col4.png", "../images/col5.png", "../images/col6.png"];
...
d3.csv("artDataset.csv").then(raw_data => { //ref: https://www.w3schools.com/js/js_promise.asp; so only executes after loaded
    ...
    paletteLayer.append("image").attr("href", "../images/transPalette.png")//can be found in folder
